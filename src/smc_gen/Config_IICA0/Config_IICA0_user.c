...
extern volatile bool g_i2c_transmit_complete;
extern volatile bool g_i2c_receive_complete;
/* End user code. Do not edit comment generated here */
...
/***********************************************************************************************************************
* Function Name: r_Config_IICA0_callback_slave_sendend
...
{
    /* Start user code for r_Config_IICA0_callback_slave_sendend. Do not edit comment generated here */
	g_i2c_transmit_complete = true;
    /* End user code. Do not edit comment generated here */
}

/***********************************************************************************************************************
* Function Name: r_Config_IICA0_callback_slave_receiveend
...
{
    /* Start user code for r_Config_IICA0_callback_slave_receiveend. Do not edit comment generated here */
	g_i2c_receive_complete = true;
    /* End user code. Do not edit comment generated here */
}

/***********************************************************************************************************************
* Function Name: r_Config_IICA0_callback_slave_error
* Description  : This function is a callback function when IICA0 slave error occurs.
* Arguments    : flag -
*                    status flag
* Return Value : None
***********************************************************************************************************************/
static void r_Config_IICA0_callback_slave_error(MD_STATUS flag)
{
    /* Start user code for r_Config_IICA0_callback_slave_error. Do not edit comment generated here */
    /* End user code. Do not edit comment generated here */
}

/***********************************************************************************************************************
* Function Name: r_Config_IICA0_callback_getstopcondition
* Description  : This function is a callback function when IICA0 gets a slave stop condition.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
static void r_Config_IICA0_callback_getstopcondition(void)
{
    /* Start user code for r_Config_IICA0_callback_getstopcondition. Do not edit comment generated here */
    /* End user code. Do not edit comment generated here */
}

/***********************************************************************************************************************
* Function Name: r_Config_IICA0_slave_handler
* Description  : This function is IICA0 slave handler
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
static void r_Config_IICA0_slave_handler(void)
{
    ...
    if (1U == SPD0)
    {
        /* Get stop condition */
        SPIE0 = 0U;
        r_Config_IICA0_callback_getstopcondition();
        ...
        if (0U == (g_iica0_slave_status_flag & _80_IICA_ADDRESS_COMPLETE))
        {
            if (1U == COI0)
            {
                ...
                if (1U == TRC0)
                {
                    ...
                    {
                        r_Config_IICA0_callback_slave_sendend();
                        WREL0 = 1U;
                    }
                }
                else
            ...
            {
                r_Config_IICA0_callback_slave_error(MD_ERROR);
            }
        }
        else
        {
            if (1U == TRC0)
            {
                if (0U == ACKD0)
                {
                    if (0U == g_iica0_tx_cnt)
                    {
                        r_Config_IICA0_callback_slave_sendend();
                    }
                    else
                    {
                        r_Config_IICA0_callback_slave_error(MD_NACK);
                    }
                ...
                if (g_iica0_rx_cnt < g_iica0_rx_len)
                {
                    *gp_iica0_rx_address = IICA0;
                    ...
                    if (g_iica0_rx_cnt == g_iica0_rx_len)
                    {
                        WTIM0 = 1U;
                        WREL0 = 1U;
                        r_Config_IICA0_callback_slave_receiveend();
                    }
                    else
                    {
                        WREL0 = 1U;
